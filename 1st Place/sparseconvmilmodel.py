...
def instantiate_sparseconvmil(embedding_size,n_out_channels_conv1,
                              n_out_channels_conv2, filter_width_conv1, filter_width_conv2, sparse_map_downsample,
                              wsi_classifier_input_n_neurons, n_classes):
    """
    Instantiates a SparseConvMIL model:
        1. A pooling function (2-layers sparse-input CNN)
        2. A classifier (1-hidden layer MLP)
