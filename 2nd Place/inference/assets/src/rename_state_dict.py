...
model_path = "./trained_models/best_model_loss_tritrain_wh_rotate.pth"
rename_state_dict_keys(model_path, key_transformation, target="./trained_models/remapped_best_model_loss_tritrain_wh_rotate.pth")